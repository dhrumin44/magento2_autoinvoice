...
namespace Dmn112\Autoinvoice\Helper;

class Data
{
    /**
     * Parameter for Dmn112 Autoinvoice configuration
     */
    CONST ENABLE_MODULE = 'dmn112/general/enable';
    CONST PAYMENT_INVOICE_CONF ='dmn112/general/specificPaymentInvoice';
    CONST PAYMENT_SHIPMENT_CONF = 'dmn112/general/specificPaymentShipments';
    CONST APPLY_ALL_METHODS ='dmn112_default_all';
    CONST EMAIL_INVOICE = 'dmn112/general/emailInvoice';
    CONST EMAIL_SHIPMENTS = 'dmn112/general/emailShipment';
    /**
